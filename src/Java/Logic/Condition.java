...
public class Condition {
    ...
    public Condition(String text, String endArmNumber) {
        this.text = text;
        this.endArmNumber = endArmNumber;
    }

    public Condition(Memory memory, String endArmNumber) {
        this.memory = memory;
        this.endArmNumber = endArmNumber;
    }

    public Condition(Alphabet alphabet, String endArmNumber) {
        this.alphabet = alphabet;
        this.endArmNumber = endArmNumber;
    }

    public Condition(Memory memoryleft, String oper, Memory memoryright, String endArmNumber) {
